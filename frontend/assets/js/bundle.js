...
/***/ "./src/AO19-exercicio/form-control.ts":
/*!********************************************!*\
  !*** ./src/AO19-exercicio/form-control.ts ***!
  \********************************************/
...
var SHOW_ERROR_MASSAGE = 'show-error-message';
...
function hideMassagesError(form) {
    form
        .querySelectorAll('.' + SHOW_ERROR_MASSAGE)
        .forEach(function (item) { return item.classList.remove(SHOW_ERROR_MASSAGE); });
}
...
function shouldSend(form) {
    var send = true;
    form.querySelectorAll('.' + SHOW_ERROR_MASSAGE).forEach(function () { return (send = false); });
    return send;
}
...
/*!**********************************************!*\
  !*** ./src/AO19-exercicio/AO19-exercicio.ts ***!
  \**********************************************/

Object.defineProperty(exports, "__esModule", ({ value: true }));
__webpack_require__(/*! ./form-control */ "./src/AO19-exercicio/form-control.ts");
